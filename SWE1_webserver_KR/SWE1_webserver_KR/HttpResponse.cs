...
namespace SWE1_webserver_KR
{
        ...
        public class ResponseProcessor
       {
           ...
           private void handleGETRequest()
           {
              ...
              writeSuccess();
              OutPutStream.WriteLine("<html><head><style>th{border:1px solid black;}</style></head>");
               OutPutStream.WriteLine("<body><h1>test server</h1>");
             ...
             OutPutStream.WriteLine("<form method=post action=/form>");
               ...
               OutPutStream.WriteLine(plugins.handleRequest(url));
           }
